...
@section('content_header')
    ...
    <ol class="breadcrumb">
        <li><a href="sponsorlist"><i class="fas fa-tachometer-alt"></i> Sponsor List</a></li>
        <li class="active">Sponsor Profile</li>
    </ol>
@stop
...
<div class="col-md-4">
    <div class="box box-primary">
        <div class="box-body box-profile">
            ...
            <p class="text-muted text-center" style="text-transform: capitalize;"> {{ $sponsor[0]->username }} </p>
            <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                    <b>E-Mail: {{ $sponsor[0]->email }}</b>
...
<div class="modal fade-in" id="update-name">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="hidden" name="id" value="{{ $sponsor[0]->user_id }}">
